...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2021 at 07:00 PM
...
CREATE TABLE `shipping_details` (
  ...
  `paymethod` varchar(655) NOT NULL,
  `bid` int(11) NOT NULL
...
INSERT INTO `shipping_details` (`id`, `name`, `address`, `postal_code`, `city`, `state`, `phone`, `f_id`, `paymethod`, `bid`) VALUES
(21, 'Tarun', ' ads', 123, 'ads', 'asd', 123, 'hiru', 'inst', 47);
